        ...
        <div class="container mt-5 py-5" data-aos="fade-up">
            ...
            <form method="post" action="{{ route('links.store') }}" role="form" class="mt-5 contact-style">
                ...
                <div class="form-group">
                    <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" placeholder="Title" value="{{old('title')}}"  data-rule="minlen:4" data-msg="Entrez le tiltre du lien" />
                    @error('title')
                ...
                <div class="form-group">
                    <input type="text" class="form-control @error('link') is-invalid @enderror" name="link" placeholder="Link" value="{{old('link')}}" id="link" data-rule="minlen:4" data-msg="Entrez le lien" />
                    @error('link')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
